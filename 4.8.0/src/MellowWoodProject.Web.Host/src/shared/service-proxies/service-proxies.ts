...
export class ListResultDtoOfPageDto implements IListResultDtoOfPageDto {
    items: PageDto[] | undefined;

    constructor(data?: IListResultDtoOfPageDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfPageDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfPageDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfPageDto {
    items: PageDto[] | undefined;
}
...
export class GetPageForEditOutput implements IGetPageForEditOutput {
    page: PageEditDto | undefined;

    constructor(data?: IGetPageForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.page = data ? PageEditDto.fromJS(data) : <any>undefined;
        }
    }

    static fromJS(data: any): GetPageForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetPageForEditOutput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["role"] = this.page ? this.page.toJSON() : <any>undefined;
        return data; 
    }

    clone(): GetPageForEditOutput {
        const json = this.toJSON();
        let result = new GetPageForEditOutput();
        result.init(json);
        return result;
...
export interface IGetPageForEditOutput {
    page: PageEditDto | undefined;
}

export class PageEditDto implements IPageEditDto {
    pageName: string;
    pageContent: string;
    id: number | undefined;

    constructor(data?: IPageEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): IPageEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new PageEditDto();
        result.init(data);
        return result;
    }
...
export class PageServiceProxy {
     ...
     * @return Success
     */
    create(input: CreatePageDto | null | undefined): Observable<CreatePageDto> {
     ...
     * @return Success
     */
    update(input: PageDto | null | undefined): Observable<PageDto> {
        let url_ = this.baseUrl + "/api/services/app/CMS/InsertOrUpdateCMSContent";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getPageForEdit(id: number | null | undefined): Observable<GetPageForEditOutput> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetPageForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetPageForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetPageForEdit(response: HttpResponseBase): Observable<GetPageForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetPageForEditOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetPageForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | null | undefined): Observable<PageDto> {
        let url_ = this.baseUrl + "/api/services/app/CMS/GetCMSContent?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getAll(): Observable<ListResultDtoOfPageDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfPageDto>><any>_observableThrow(e);
                }
            } else
            {

                return <Observable<ListResultDtoOfPageDto>><any>_observableThrow(response_);
            }
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfPageDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResultDtoOfPageDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfPageDto>(<any>null);
    }
}
